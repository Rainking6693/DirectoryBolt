-- Fix RLS Policies for DirectoryBolt
-- This script enables Row Level Security and creates necessary policies
...
-- Create policies for customer_stats view (if it's a view)
CREATE POLICY "Allow all operations for service role" ON public.customer_stats
    FOR ALL USING (true) WITH CHECK (true);
