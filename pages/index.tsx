...
function TailwindDemo() {
  return (
    <div className="fixed top-4 right-4 z-50 no-print">
      <div className="rounded-xl border p-4 shadow bg-white max-w-xs">
        <h3 className="text-2xl font-bold text-gray-900 mb-2">Tailwind OK</h3>
        <p className="text-sm text-gray-600">If this renders styled, Tailwind is working.</p>
