    ...
    const mockQueue: QueueItem[] = [
      {
        ...
        notes: 'High priority customer - enterprise client'
      },
      {
        id: 'q2',
        ...
        assignedTo: 'staff',
        directoryCount: 50,
        completedDirectories: 25,
        notes: 'Standard processing - no special requirements'
      },
      {
        id: 'q3',
        ...
        directoryCount: 500,
        completedDirectories: 500,
        notes: 'Completed successfully - all directories submitted'
      },
      {
        id: 'q4',
        customerId: 'DIR-20250916-000005',
        businessName: 'Local Coffee Shop',
        packageType: 'growth',
        status: 'failed',
        priority: 'low',
        created: '2025-01-08T08:45:00Z',
        directoryCount: 75,
        completedDirectories: 15,
        notes: 'Failed due to incomplete business information'
      }
    ];
