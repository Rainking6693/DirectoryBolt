...
let directoryBoltQueueManager = null;
...
async function initializeAdvancedComponents() {
    try {
        ...
        await loadScript('queue-manager.js');
        ...
        // Initialize DirectoryBolt queue manager
        const DirectoryBoltQueueManager = globalThis.DirectoryBoltQueueManager;
        if (DirectoryBoltQueueManager) {
            directoryBoltQueueManager = new DirectoryBoltQueueManager();
            await directoryBoltQueueManager.startQueueMonitoring();
