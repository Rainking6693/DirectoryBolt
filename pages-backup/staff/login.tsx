...
export default function StaffLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Test the API key by making a request to the auth check endpoint
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="DirectoryBolt Staff Login" />
        ...
        <div className="max-w-md w-full space-y-8">
          <div>
            ...
            <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
              DirectoryBolt Staff Portal
            </h2>
            <p className="mt-2 text-center text-sm text-gray-600">
              Enter your staff API key to access the dashboard
            </p>
          </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <p>This portal is for DirectoryBolt staff members to manage customer processing queues and analytics.</p>
                </div>
              </div>
            </div>
          </div>
