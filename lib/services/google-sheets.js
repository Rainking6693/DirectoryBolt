...
class GoogleSheetsConfig {
  constructor() {
    ...
    if (missingVars.length > 0) {
      const errorMessage = `🚨 NETLIFY FUNCTIONS ENVIRONMENT ERROR: Missing environment variables: ${missingVars.join(', ')}. 
      ...
      This indicates a Netlify Functions deployment issue where environment variables configured in Netlify Dashboard are not accessible at runtime.`;
