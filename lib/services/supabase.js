...
class SupabaseService {
  ...
  async getCustomerById(customerId) {
    try {
      ...
      // First try to find by original customer ID in metadata (for migrated customers)
      ...
      // If not found in metadata, try the old customer_id field for backwards compatibility
