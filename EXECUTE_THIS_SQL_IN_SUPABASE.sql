-- DirectoryBolt Database Schema for Supabase
-- CRITICAL: Execute this ENTIRE script in Supabase Dashboard SQL Editor
...
('DIR-20250917-000001', 'John', 'Doe', 'Sample Business 1', 'john@samplebusiness1.com', 'professional', 'active'),
('DIR-20250917-000002', 'Jane', 'Smith', 'Sample Business 2', 'jane@samplebusiness2.com', 'growth', 'pending');
